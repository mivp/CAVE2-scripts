...
static void client_recv(void)
{
    ...
    //	  fprintf(stderr,"client recv1\n");

    sync_buffer();

    //	  fprintf(stderr,"client recv2\n");
    ...
    while ((event = recv_event()))
        ...
        case EVENT_SET_CAMERA_IMAGE:      recv_set_camera_image();      break;
...
void client(void)
{
	...
	//	  fprintf(stderr,"client 1\n");
	  ...
	  // fprintf(stderr,"client 2\n");
	    ...
	    //fprintf(stderr,"client 3\n");

            sync_display();

	    //fprintf(stderr,"client 4\n");
