...
#include <lua.h>
//http://lua-users.org/lists/lua-l/2011-06/msg00795.html
#include <lauxlib.h>
#include <lualib.h>
...
static int E_set_camera_image(lua_State *L)
{
    send_set_camera_image(E_getcamera(L, -6),
                          E_getimage (L, -5),
                          L_getnumber(L, -4),
                          L_getnumber(L, -3),
                          L_getnumber(L, -2),
...
static struct function_def functions[] = {
    ...
    { "set_camera_image",      E_set_camera_image      },
